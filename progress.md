...
- Verified process-level real-media CLI E2E from `/tmp/mediaorchard-real-cli-e2e.OfiT2z/output/job_b2643ea1001c`: generated mp4 input, ran Worker `--execution-mode real`, completed the job, and checked metadata, audio, transcript, subtitle, quality report, human report, and logs.
