...
- Clean checkout verification passed from `/tmp/mediaorchard-clean-check.Kg5RdV/repo` after fresh clone, new venv, editable install, `bash scripts/verify.sh` with 92 tests, and `bash scripts/smoke.sh`.
